...
#### Function
Returns the current list of validators. See the [Bor documentation](https://wiki.polygon.technology/docs/pos/heimdall/modules/bor/) for more information about Polygon validators.
...
array - the signers of the block
